...
export const OxygenBar: React.FC<OxygenBarProps> = ({
  value,
  maxValue = 100,
  className = ''
}) => {
          ...
          <div
            ...
            style={{ 
              ...
              background: isCritical 
                ...
                : `linear-gradient(to top, ${getCSSVariable('--hud-oxygen-color', '#8b5cf6')}, ${getCSSVariable('--hud-oxygen-color', '#8b5cf6')})`,
              boxShadow: isCritical 
                ? '0 0 8px rgba(239, 68, 68, 0.8)' 
                : `0 0 6px ${getCSSVariableWithAlpha('--hud-oxygen-color', '#8b5cf6', 0.6)}`
            }}
          />
